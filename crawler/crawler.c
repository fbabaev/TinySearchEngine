/*
 * crawler.c - Web crawler module for CS50
 *
 * This module crawls web pages starting from a seed URL.
 * It fetches pages, scans them for links, and continues this process
